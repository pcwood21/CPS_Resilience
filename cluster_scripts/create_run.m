...
qsub_args='qsub -l nodes=1,walltime=01:00:00';
exec_dir='/strg/scratch/cpssim/cnexp2/';
%exec_dir='D:/temp';
data_dir=strcat(exec_dir,'../results/rundata');
script_dir=strcat(exec_dir,'../results/scripts');
mkdir(data_dir);
mkdir(script_dir);
